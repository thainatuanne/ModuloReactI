        ...
        <ThemeProvider theme={lightTheme}>
            ...
            <FooterStyled>
                <div>
                    ...
                    <p>{new Date().getFullYear()} GrowTravel. Todos os direitos reservados.</p>

                    <p>
                        Desenvolvido por{' '}
                        <a href="https://portfolio-two-sage-12.vercel.app/" target="_blank">
                            Thainá Tuanne Borges da Silva
                        </a>
                    </p>
                </div>
            </FooterStyled>
